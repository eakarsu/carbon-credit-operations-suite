...
PORT="${PORT:-5640}"
DB_NAME="${PGDATABASE:-carbon_credit_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Carbon Credit Operations Suite"
echo "======================================="
echo
...
echo "Starting carbon credit operations suite frontend on http://localhost:$PORT"
echo "Login: admin@carbon-credit-operations.local / admin123"
