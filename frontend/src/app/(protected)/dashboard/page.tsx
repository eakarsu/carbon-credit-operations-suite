...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Carbon Credit Operations Dashboard"
      subtitle="One merged carbon credit operations view for Accounts, Applications, Transactions, Reviews, Approvals, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared carbon credit operations jobs into one surface. Accounts, Applications, Transactions, Reviews, Approvals, Exceptions, documents, audit, and AI are presented as platform features.</div>
