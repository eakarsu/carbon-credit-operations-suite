...
const entitySeeds = [
  ...
  ["carbon-credit-review","Carbon Credit Review Records","Carbon Credit Review operating queue","Open","Carbon Credit Review follow-up list","Carbon Credit Verification","$0"],
  ["registry-validation","Registry Validation Records","Registry Validation operating queue","Review","Registry Validation follow-up list","Carbon Credit Verification","$0"],
  ["offset-project-risk","Offset Project Risk Records","Offset Project Risk operating queue","Review","Offset Project Risk follow-up list","Carbon Credit Verification","$0"],
  ["methodology-eligibility","Methodology Eligibility Records","Methodology Eligibility operating queue","Open","Methodology Eligibility follow-up list","Carbon Credit Deep Workflows","$0"],
  ["additionality-evidence","Additionality Evidence Records","Additionality Evidence operating queue","Review","Additionality Evidence follow-up list","Carbon Credit Deep Workflows","$0"],
  ["retirement-duplicate-check","Retirement Duplicate Check Records","Retirement Duplicate Check operating queue","Review","Retirement Duplicate Check follow-up list","Carbon Credit Deep Workflows","$0"],
  ["vintage-price-review","Vintage Price Review Records","Vintage Price Review operating queue","Review","Vintage Price Review follow-up list","Carbon Credit Deep Workflows","$0"],
