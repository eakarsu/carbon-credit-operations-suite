...
export const sourceSystems = [
  { name: 'AICarbonCreditOperationsAssistant', ownership: 'Accounts source capabilities and workflows', coverage: ['Accounts', 'Applications', 'Transactions'] },
  { name: 'AICarbonCreditOperationsOperations', ownership: 'Applications source capabilities and workflows', coverage: ['Reviews', 'Approvals', 'Exceptions'] },
  { name: 'AICarbonCreditOperationsAnalytics', ownership: 'Transactions source capabilities and workflows', coverage: ['Risk Scores', 'Statements', 'Compliance'] },
  { name: 'AICarbonCreditOperationsWorkflow', ownership: 'Reviews source capabilities and workflows', coverage: ['Forecasts', 'Analytics', 'Reports'] },
];
