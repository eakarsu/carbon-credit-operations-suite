...
const featureSeeds = [
  ['records', 'Accounts', 'Accounts operating queue', 'Finance Lead', 'Review and assign next action'],
  ['applications', 'Applications', 'Applications operating queue', 'Finance Lead', 'Review and assign next action'],
  ['transactions', 'Transactions', 'Transactions operating queue', 'Finance Lead', 'Review and assign next action'],
  ['reviews', 'Reviews', 'Reviews operating queue', 'Finance Lead', 'Review and assign next action'],
  ...
  ['risk-scores', 'Risk Scores', 'Risk Scores operating queue', 'Operations Lead', 'Review and assign next action'],
  ['statements', 'Statements', 'Statements operating queue', 'Operations Lead', 'Review and assign next action'],
  ['compliance', 'Compliance', 'Compliance operating queue', 'Governance Lead', 'Review and assign next action'],
  ['forecasts', 'Forecasts', 'Forecasts operating queue', 'Governance Lead', 'Review and assign next action'],
  ...
  ["carbon-credit-review","Carbon Credit Review","Carbon Credit Review review queue","Carbon Credit Verification","Review source context and assign owner"],
  ["registry-validation","Registry Validation","Registry Validation review queue","Carbon Credit Verification","Confirm next action and update evidence"],
  ["offset-project-risk","Offset Project Risk","Offset Project Risk review queue","Carbon Credit Verification","Confirm next action and update evidence"],
  ["methodology-eligibility","Methodology Eligibility","Methodology Eligibility workspace","Carbon Credit Deep Workflows","Review source evidence and assign owner"],
  ["additionality-evidence","Additionality Evidence","Additionality Evidence workspace","Carbon Credit Deep Workflows","Confirm findings, next action, and audit evidence"],
  ["retirement-duplicate-check","Retirement Duplicate Check","Retirement Duplicate Check workspace","Carbon Credit Deep Workflows","Confirm findings, next action, and audit evidence"],
  ["vintage-price-review","Vintage Price Review","Vintage Price Review workspace","Carbon Credit Deep Workflows","Confirm findings, next action, and audit evidence"],
