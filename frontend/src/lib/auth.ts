export const AUTH_COOKIE = 'carbon_credit_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@carbon-credit-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@carbon-credit-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@carbon-credit-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
